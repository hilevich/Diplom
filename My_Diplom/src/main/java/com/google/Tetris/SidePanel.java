...
public class SidePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		/*
		 * This variable stores the current y coordinate of the string. This way
		 * we can re-order, add, or remove new strings if necessary without
		 * needing to change the other strings.
		 */
		int offset;
		...
		if (!tetris.isGameOver() && type != null) {
			...
			/*
			 * Get the insets for the preview. The default rotation is used for
			 * the preview, so we just use 0.
			 */
