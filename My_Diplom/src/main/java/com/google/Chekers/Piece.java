...
/**
 * A Piece on the game board that can be either red or black Pieces are taken
 * into account when redrawing a Square on the game board and when a particular
 * side runs out of pieces, the game is over
 * 
...
public class Piece {
	 ...
	 * @param row
	 *            The row of the game board this piece lives on
	 * @param col
	 *            The column of the game board this piece lives on
	 */
	 ...
	 * 
	 * @param row
	 *            The new row for this piece to live on
	 * @param col
	 *            The new column for this piece to live on
	 */
	...
	public String toString() {
		...
		s.append("piece at row " + Integer.toString(this.getRow()) + ", col " + Integer.toString(this.getCol()));
