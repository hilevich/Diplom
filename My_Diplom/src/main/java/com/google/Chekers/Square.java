...
public class Square extends Canvas {
	 ...
	 * 
	 * @param doHighlight
	 *            Whether or not this square should be highlighted
	 */
	public void setHighlight(boolean doHighlight) {
		...
		if (doHighlight) {
			...
			// If this square has a highlight in it, erase it by redrawing the
			// Square
	 ...
	 * 
	 * @param g
	 *            The Graphics object belonging to this Square
	 * 
	 */
