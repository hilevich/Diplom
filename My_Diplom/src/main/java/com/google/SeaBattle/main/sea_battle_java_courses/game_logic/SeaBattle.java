...
import com.google.SeaBattle.main.sea_battle_java_courses.swing_logic.Sector;
import com.google.SeaBattle.main.sea_battle_java_courses.swing_logic.SwingField;
...
public class SeaBattle {
	...
	private void showWinMessageBox(String message, boolean userWin) {
		...
		int result = JOptionPane.showOptionDialog(seaBattleSwing.getComputerField().getParent(),
				"Хотите сыграть еще раз ?", message, JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE,
